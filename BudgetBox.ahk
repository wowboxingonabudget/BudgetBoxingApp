...
Gui, Add, Edit, xp+100 r1 cBlack vWindow_Two_Name w135, 2WOW
Gui, Add, Checkbox, xm+20 cWhite vWindow_Three_CheckBox gSubmit_All, Window Three
Gui, Add, Edit, xp+100 r1 cBlack vWindow_Three_Name w135, 3WOW
Gui, Add, Checkbox, xm+20 cWhite vWindow_Four_CheckBox gSubmit_All, Window Four
Gui, Add, Edit, xp+100 r1 cBlack vWindow_Four_Name w135, 4WOW

;Follow button
Gui, Add, Button, xm+40 yp+50 h20 gSend_Focus_Command, Set Focus
Gui, Add, Edit, xp+70 yp cBlack vFollow_Char_Name w135, Lead Char Name
...
Gui,Add, Checkbox, cWhite vEnable_f9_Broadcast gSubmit_All, f9
...
$f9::
if(Enable_Broadcasting==1 and Enable_f9_Broadcast == 1) {
	if(Window_One_CheckBox==1)
